...
const SLUG = "doma-iz-keramicheskih-blokov";
const URL = "https://shadov.pro/doma-iz-keramicheskih-blokov";
      ...
      scripts: [
        {
          ...
          children: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 3, name: "Дома из керамических блоков", item: URL },
            ],
          }),
        },
        {
