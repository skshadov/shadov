    ...
    >
      ...
      <InfoSection title="Что влияет на итоговую сумму">
        <p>
          ...
          МКАД и работа по выходным. Подъём материалов на этаж мы не выполняем — это задача поставщика или грузчиков. Никаких «выяснилось на месте» — замерщик фиксирует все
