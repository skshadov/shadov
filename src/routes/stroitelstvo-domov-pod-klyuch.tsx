...
const SLUG = "stroitelstvo-domov-pod-klyuch";
const URL = "https://shadov.pro/stroitelstvo-domov-pod-klyuch";
      ...
      scripts: [
        {
          ...
          children: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 3, name: "Строительство домов под ключ", item: URL },
            ],
          }),
        },
        {
