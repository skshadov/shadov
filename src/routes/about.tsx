  ...
  return (
    ...
    >
      ...
      <InfoSection title="Почему с нами хочется работать">
        <InfoList
          items={[
            ...
            "Прозрачная смета. В прайсе отдельно указаны работа, материал и итог «под ключ» — без «уточним по ходу».",
      ...
      <InfoSection title="Наш подход">
        ...
        <p className="mt-3">
          Мокрую стяжку мы выбрали осознанно: она надёжнее полусухой,
          равномерно набирает прочность и лучше работает в связке с
          тёплым полом.
        </p>
      </InfoSection>
      ...
      <InfoSection title="Направления работ">
        <InfoList
          items={[
            ...
            "Мокрая цементно-песчаная стяжка пола",
