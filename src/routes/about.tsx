  ...
  return (
    ...
    >
      ...
      <InfoSection title="Документы">
        <PlaceholderNotice
          title="Документы публикуются после заполнения реквизитов"
          description="Документы и подтверждающие сведения публикуются после заполнения реквизитов и проверки материалов. По запросу мы предоставим актуальные документы напрямую."
        />
      </InfoSection>
    </InfoPageLayout>
  );
