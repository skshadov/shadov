...
function Page() {
  return (
    ...
    >
      ...
      <InfoSection title="4. Обработка обращений через формы">
        <p>Данные, отправленные через формы сайта, поступают в защищённую информационную систему компании и обрабатываются ответственными сотрудниками для подготовки предварительного расчёта и связи с пользователем. Порядок обработки — в <Link to="/privacy" className="text-primary underline underline-offset-2 hover:opacity-80">политике конфиденциальности</Link>.</p>
      </InfoSection>
