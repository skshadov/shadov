...
const members: { name: string; role: string; photo: string }[] = [
  ...
  { name: "Дмитрий Соколов",     role: "Бригадир по стяжке пола",               photo: m02 },
  { name: "Андрей Кузнецов",     role: "Мастер по штукатурке откосов",                       photo: m03 },
  { name: "Сергей Васильев",     role: "Электромонтажник",                        photo: m04 },
  { name: "Михаил Петров",       role: "Сантехник-монтажник",                     photo: m05 },
  { name: "Николай Морозов",     role: "Мастер стяжки пола",                              photo: m06 },
  { name: "Игорь Смирнов",       role: "Штукатур-механизатор",                                photo: m07 },
  { name: "Владимир Попов",      role: "Сварщик трубопроводов",                                 photo: m08 },
  { name: "Павел Новиков",       role: "Штукатур-механизатор",                               photo: m09 },
  { name: "Артём Орлов",         role: "Штукатур-маляр",                          photo: m10 },
  { name: "Роман Лебедев",       role: "Монтажник тёплого пола",        photo: m11 },
  { name: "Виктор Зайцев",       role: "Монтажник тёплого пола",             photo: m12 },
  { name: "Евгений Фёдоров",     role: "Специалист по нивелированию полов",                               photo: m13 },
  ...
  { name: "Татьяна Ковалёва",    role: "Менеджер по замерам",                     photo: m19 },
  { name: "Светлана Морозова",   role: "Инженер-проектировщик инженерных систем",                           photo: m20 },
  { name: "Денис Сорокин",       role: "Бригадир черновых работ",         photo: m21 },
  { name: "Юрий Кулагин",        role: "Подсобный рабочий-механизатор",                                 photo: m22 },
  { name: "Геннадий Антонов",    role: "Сварщик-полипропиленщик",                        photo: m23 },
  { name: "Ирина Лазарева",      role: "Инженер ПТО",                             photo: m24 },
  { name: "Олег Тарасов",        role: "Электромонтажник слаботочных систем",     photo: m25 },
  { name: "Кирилл Жуков",        role: "Мастер стяжки пола",                    photo: m26 },
  { name: "Степан Гончаров",     role: "Штукатур",                                photo: m27 },
  { name: "Тимур Белов",         role: "Штукатур-механизатор",               photo: m28 },
  { name: "Анатолий Карпов",     role: "Бригадир штукатурных работ",                       photo: m29 },
  { name: "Максим Шевченко",     role: "Монтажник тёплого пола",             photo: m30 },
  { name: "Юлия Дроздова",       role: "Менеджер по замерам",                     photo: m31 },
  { name: "Виталий Кравцов",     role: "Старший прораб",                          photo: m32 },
  { name: "Дарья Семёнова",      role: "Специалист по нивелированию полов",                               photo: m33 },
  { name: "Леонид Воронин",      role: "Оператор штукатурной станции",                photo: m34 },
  { name: "Антон Михайлов",      role: "Мастер стяжки пола",                                photo: m35 },
  { name: "Иван Гусев",          role: "Сантехник-монтажник",                     photo: m36 },
  { name: "Лариса Дмитриева",    role: "Специалист отдела снабжения",             photo: m37 },
  { name: "Алексей Поляков",     role: "Мастер механизированной штукатурки",               photo: m38 },
  { name: "Наталья Романова",    role: "Инженер по качеству",                     photo: m39 },
  { name: "Борис Афанасьев",     role: "Старший мастер по стяжке",                         photo: m40 },
  { name: "Никита Воробьёв",     role: "Штукатур-механизатор",                           photo: m41 },
  { name: "Григорий Соболев",    role: "Монтажник тёплого пола",               photo: m42 },
  ...
  { name: "Денис Прохоров",      role: "Штукатур",                                   photo: m46 },
  { name: "Вера Никонова",       role: "Инженер-сметчик",                         photo: m47 },
  { name: "Валерий Сидоров",     role: "Мастер сантехнических систем",            photo: m48 },
  { name: "Алина Куликова",      role: "Инженер-технолог",                              photo: m49 },
  { name: "Руслан Маркин",       role: "Заведующий складом",                      photo: m50 },
  { name: "Аслан Дудаев",        role: "Бригадир по стяжке пола",               photo: m51 },
  { name: "Магомед Закаев",      role: "Штукатур-механизатор",                                photo: m52 },
  { name: "Ислам Эдильгериев",   role: "Сварщик трубопроводов",                                 photo: m53 },
  { name: "Адам Кадыров",        role: "Подсобный рабочий-механизатор",                                 photo: m54 },
  { name: "Хасан Бакаев",        role: "Прораб",                                  photo: m55 },
  { name: "Хусейн Дадаев",       role: "Электромонтажник",                        photo: m56 },
  { name: "Рамзан Висаитов",     role: "Мастер стяжки пола",                              photo: m57 },
  { name: "Ахмед Алиханов",      role: "Бригадир черновых работ",         photo: m58 },
  { name: "Беслан Юсупов",       role: "Штукатур-механизатор",                           photo: m59 },
  { name: "Анзор Тагаев",        role: "Штукатур-маляр",                          photo: m60 },
  { name: "Иса Хамзатов",        role: "Мастер стяжки пола",                    photo: m61 },
  { name: "Муса Эльмурзаев",     role: "Мастер стяжки пола",                                photo: m62 },
  { name: "Тимур Сулейманов",    role: "Мастер по штукатурке откосов",                       photo: m63 },
  { name: "Шамиль Исраилов",     role: "Монтажник тёплого пола",        photo: m64 },
  { name: "Заурбек Цечоев",      role: "Сантехник-монтажник",                     photo: m65 },
  { name: "Магомед Гаджиев",     role: "Бригадир штукатурных работ",               photo: m66 },
  { name: "Расул Магомедов",     role: "Штукатур-механизатор",                                photo: m67 },
  { name: "Гаджи Алиев",         role: "Электромонтажник",                        photo: m68 },
  { name: "Ибрагим Курбанов",    role: "Прораб",                                  photo: m69 },
  { name: "Шамиль Абдулаев",     role: "Подсобный рабочий-механизатор",                                 photo: m70 },
  { name: "Курбан Исаев",        role: "Сварщик-полипропиленщик",                        photo: m71 },
  { name: "Али Османов",         role: "Штукатур-механизатор",               photo: m72 },
  { name: "Камиль Рамазанов",    role: "Штукатур",                                photo: m73 },
  { name: "Юсуп Магомедов",      role: "Штукатур-механизатор",                               photo: m74 },
  { name: "Арсен Гасанов",       role: "Бригадир по стяжке пола",               photo: m75 },
  { name: "Заур Ибрагимов",      role: "Монтажник тёплого пола",             photo: m76 },
  { name: "Мурад Алибеков",      role: "Сантехник-монтажник",                     photo: m77 },
  { name: "Саид Меджидов",       role: "Мастер механизированной штукатурки",               photo: m78 },
  { name: "Абдул Нурмагомедов",  role: "Штукатур",                                   photo: m79 },
  { name: "Магомедрасул Багиров", role: "Мастер стяжки пола",                               photo: m80 },
];
