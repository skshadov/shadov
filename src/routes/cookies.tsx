  ...
  return (
    ...
    >
      <InfoSection title="Общее">
        <p>Сайт использует только строго необходимые cookie и локальное хранилище браузера для работы форм и сохранения их черновиков. Аналитические и рекламные cookie не устанавливаются без отдельного согласия пользователя.</p>
      </InfoSection>

      <InfoSection title="Cookie">
        <p>Технические cookie устанавливаются для поддержания служебной сессии администратора и защиты от подделки запросов. Cookie сторонних рекламных и аналитических систем не используются.</p>
      </InfoSection>
      ...
      <InfoSection title="localStorage">
        <ul className="list-disc space-y-2 pl-5">
          ...
          <li>Ключи сервиса аутентификации — хранят токен служебной сессии администратора; удаляются при выходе из аккаунта.</li>
        </ul>
      </InfoSection>
