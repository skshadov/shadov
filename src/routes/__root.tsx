...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Шадов и партнёры — штукатурка, стяжка и черновая инженерия" },
      { property: "og:title", content: "Шадов и партнёры — штукатурка, стяжка и черновая инженерия" },
      { name: "twitter:title", content: "Шадов и партнёры — штукатурка, стяжка и черновая инженерия" },
      { name: "description", content: "Механизированная штукатурка, мокрая стяжка пола, тёплый пол, черновая электрика и сантехника в Москве и области. Фиксированная смета и гарантия по договору." },
      { property: "og:description", content: "Механизированная штукатурка, мокрая стяжка пола, тёплый пол, черновая электрика и сантехника в Москве и области. Фиксированная смета и гарантия по договору." },
      { name: "twitter:description", content: "Механизированная штукатурка, мокрая стяжка пола, тёплый пол, черновая электрика и сантехника в Москве и области. Фиксированная смета и гарантия по договору." },
