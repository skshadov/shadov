...
export const CALCULATOR_MODE_SPECS: CalculatorModeSpec[] = [
  ...
  },
  {
    ...
    description:
      "9 технологий и 4 уровня готовности. Цены только за работу — материалы покупает заказчик.",
    priceCategories: ["house_construction_work"],
    packageCategories: ["house_construction_work"],
    separateCategories: [],
    forbiddenAutoCalculations: [
      "Стоимость материалов в расчёт не входит — их покупает заказчик.",
...
export const CALCULATOR_DISCLAIMERS: string[] = [
  ...
  "Все цены — только за работу. Материалы и оборудование заказчик покупает сам; по договорённости мы можем закупить и доставить их, стоимость обсуждается отдельно.",
];
...
export const CALCULATOR_METADATA = {
  ...
  title: "Калькулятор стоимости работ — Шадов и партнёры",
  description:
    "Предварительный расчёт стоимости штукатурки, мокрой стяжки пола, черновой электрики, черновой сантехники и тёплых полов по актуальному прайсу.",
