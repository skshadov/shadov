...
const ELECTRICAL: PriceItem[] = [
  ...
  make("electrical", "podrozetnik-penoblok",     "Подрозетник в пеноблоке (сверление и вмазывание)",       { unit: "шт.", from: 850, slug: "elektromontazh", sort: 3 }),
  make("electrical", "podrozetnik-kirpich",      "Подрозетник в кирпиче (сверление и вмазывание)",         { unit: "шт.", from: 1400, slug: "elektromontazh", sort: 4 }),
  make("electrical", "rozetka-vykl",             "Установка розетки или выключателя",                      { unit: "шт.", from: 650, slug: "elektromontazh", sort: 5 }),
  make("electrical", "provodka-pol",             "Монтаж проводки по полу",                                { unit: "пог. м", from: 300, slug: "elektromontazh", sort: 6 }),
  make("electrical", "provodka-potolok",         "Монтаж проводки по потолку",                             { unit: "пог. м", from: 350, slug: "elektromontazh", sort: 7 }),
  make("electrical", "kabelnyy-lotok",           "Монтаж кабельного лотка",                                { unit: "пог. м", from: 500, slug: "elektromontazh", sort: 8 }),
  make("electrical", "shtroblenie-penoblok",     "Штробление пеноблока и газоблока",                       { unit: "пог. м", from: 850, slug: "elektromontazh", sort: 9 }),
  make("electrical", "shtroblenie-kirpich",      "Штробление кирпича",                                     { unit: "пог. м", from: 1400, slug: "elektromontazh", sort: 10 }),
  make("electrical", "shtroblenie-beton",        "Штробление бетона",                                      { unit: "пог. м", from: 1700, slug: "elektromontazh", sort: 11 }),
  make("electrical", "podrozetnik-beton",        "Подрозетник в бетоне (сверление и вмазывание)",          { unit: "шт.", from: 1700, slug: "elektromontazh", sort: 12 }),
  make("electrical", "vnutr-shchit",             "Установка внутреннего электрощита",                      { unit: "шт.", from: 10000, slug: "elektromontazh", sort: 13 }),
  make("electrical", "sborka-shchita",           "Сборка щита: корпус, ввод, шины, маркировка",            { unit: "комплект", from: 7600, slug: "elektromontazh", sort: 14 }),
  make("electrical", "shchit-12",                "Щит на 12 модулей под ключ",                             { unit: "комплект", from: 30400, slug: "elektromontazh", sort: 15 }),
  make("electrical", "shchit-18",                "Щит на 18 модулей под ключ",                             { unit: "комплект", from: 41800, slug: "elektromontazh", sort: 16 }),
  make("electrical", "shchit-24",                "Щит на 24 модуля под ключ",                              { unit: "комплект", from: 53200, slug: "elektromontazh", sort: 17 }),
  make("electrical", "shchit-36",                "Щит на 36 модулей под ключ",                             { unit: "комплект", from: 76000, slug: "elektromontazh", sort: 18 }),
  make("electrical", "shchit-48",                "Щит на 48 модулей под ключ",                             { unit: "комплект", from: 98800, slug: "elektromontazh", sort: 19 }),
  make("electrical", "podklyuchenie-avtomata",   "Установка и подключение модуля (автомат — 1 модуль, УЗО или диф — 2)", { unit: "модуль", from: 1900, slug: "elektromontazh", sort: 16 }),
  make("electrical", "raspredkorobka",           "Монтаж распределительной коробки с расключением",        { unit: "шт.", from: 2900, slug: "elektromontazh", sort: 23 }),
