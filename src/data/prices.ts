...
const ELECTRICAL: PriceItem[] = [
  ...
  make("electrical", "podrozetnik-penoblok",     "Подрозетник в пеноблоке (сверление и вмазывание)",       { unit: "шт.", from: 900, slug: "elektromontazh", sort: 3 }),
  make("electrical", "podrozetnik-kirpich",      "Подрозетник в кирпиче (сверление и вмазывание)",         { unit: "шт.", from: 1500, slug: "elektromontazh", sort: 4 }),
  make("electrical", "rozetka-vykl",             "Установка розетки или выключателя",                      { unit: "шт.", from: 650, slug: "elektromontazh", sort: 5 }),
  make("electrical", "provodka-pol",             "Монтаж проводки по полу",                                { unit: "пог. м", from: 350, slug: "elektromontazh", sort: 6 }),
  make("electrical", "provodka-potolok",         "Монтаж проводки по потолку",                             { unit: "пог. м", from: 400, slug: "elektromontazh", sort: 7 }),
  make("electrical", "kabelnyy-lotok",           "Монтаж кабельного лотка",                                { unit: "пог. м", from: 500, slug: "elektromontazh", sort: 8 }),
  make("electrical", "shtroblenie-penoblok",     "Штробление пеноблока и газоблока",                       { unit: "пог. м", from: 900, slug: "elektromontazh", sort: 9 }),
  make("electrical", "shtroblenie-kirpich",      "Штробление кирпича",                                     { unit: "пог. м", from: 1500, slug: "elektromontazh", sort: 10 }),
  make("electrical", "shtroblenie-beton",        "Штробление бетона",                                      { unit: "пог. м", from: 1800, slug: "elektromontazh", sort: 11 }),
  make("electrical", "podrozetnik-beton",        "Подрозетник в бетоне (сверление и вмазывание)",          { unit: "шт.", from: 1800, slug: "elektromontazh", sort: 12 }),
