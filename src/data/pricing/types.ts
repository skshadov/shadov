...
export interface CalcConfig {
  ...
  baseRowKey?: string;
  /**
   * Взаимоисключающие варианты основной работы (ключи позиций прайса).
   * Первый — по умолчанию. Пользователь выбирает один: гипс или цемент,
   * стена или потолок, водяной или электрический пол.
   */
  baseVariantKeys?: string[];
  /** Подпись над выбором варианта основной работы */
