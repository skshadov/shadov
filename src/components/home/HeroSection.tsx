      ...
      <div className="container-page relative grid gap-10 py-10 md:py-14 lg:grid-cols-12 lg:items-center lg:gap-12 lg:py-16">
        <div className="lg:col-span-6">
          ...
          <p className="mt-6 max-w-2xl text-base leading-relaxed text-muted-foreground sm:text-lg">
            Механизированная штукатурка, мокрая и полусухая стяжка пола, тёплый пол, разводка электрики и сантехники в Москве и области. Прайс без «от»: цены только за работу, материалы заказчик покупает сам — при необходимости закупим и доставим, это обсуждается отдельно.
          </p>
