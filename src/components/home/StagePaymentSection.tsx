/**
 * §4 + §12.5 ТЗ — поэтапная оплата. 6 шагов из ТЗ.
 */
import { SectionHeading } from "@/components/common/SectionHeading";

const STEPS = [
  { n: "1", title: "Деление объекта на этапы", text: "Объём заранее делится на технологически понятные этапы (например, разводка электрики и сантехники, штукатурка, тёплый пол, стяжка)." },
  ...
  { n: "4", title: "Отчётность и приёмка", text: "Заказчик получает фотоотчёт и принимает этап на объекте. По замечанию формируется задача ответственному сотруднику." },
  { n: "5", title: "Авансирование следующего этапа", text: "После приёмки авансируется следующий этап. Заказчик не оплачивает весь объект заранее." },
  { n: "6", title: "Финальная сдача и документы", text: "После завершения всех этапов оформляется итоговая приёмка, гарантийные обязательства и комплект документов." },
];
